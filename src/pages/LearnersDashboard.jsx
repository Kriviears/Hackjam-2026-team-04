      ...
      <main className="dashboard-main">
        ...
        <section className="dashboard-card roadmap-section">
          <div className="section-title-row">
            <div>
              ...
              <h2>Your Path to Software Engineering</h2>
            </div>

            <span className="roadmap-summary">3 of 8 completed</span>
          </div>

          <div className="roadmap-wrapper">
            {roadmap.map((item, index) => (
              <React.Fragment key={item.id}>
                <div className={`roadmap-item ${item.type}`}>
                  <div className="roadmap-node">{item.icon}</div>
          ...
          <article className="dashboard-card resources-section">
            ...
            <div className="resource-list">
              {resources.map((resource) => (
                <button className="resource-card" type="button" key={resource.id}>
        ...
        <section className="dashboard-card ai-recommendation">
          ...
          <div>
            ...
            <h2>
              Complete Express APIs this week to increase your Software
              Engineer readiness by 11%.
            </h2>
          </div>
